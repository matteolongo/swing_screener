"""Repository for dedicated fundamentals configuration."""
...
from swing_screener.settings import config_dir
...
class FundamentalsConfigRepository:
    def __init__(self, path: str | Path | None = None) -> None:
        self.path = Path(path) if path is not None else config_dir() / "fundamentals.yaml"
