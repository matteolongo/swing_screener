...
def to_daily_review_candidate(c) -> DailyReviewCandidate:
    ...
    return DailyReviewCandidate(
        ...
        data_asof=c.data_asof,
        degraded_reasons=c.degraded_reasons,
        intelligence_asof=c.intelligence_asof,
        raw_technical_rank=c.raw_technical_rank,
        combined_priority_score=c.combined_priority_score,
        sma20_slope=c.sma20_slope,
        sma50_slope=c.sma50_slope,
        consolidation_tightness=c.consolidation_tightness,
        close_location_in_range=c.close_location_in_range,
        above_breakout_extension=c.above_breakout_extension,
        breakout_volume_confirmation=c.breakout_volume_confirmation,
