...
**User Guides:**
- `web-ui/docs/WEB_UI_GUIDE.md` - How to use the Web UI
- `docs/product/DAILY_USAGE_GUIDE.md` - Daily trading workflow
- `docs/engineering/OPERATIONAL_GUIDE.md` - CLI workflows

**Technical Guides:**
- `web-ui/docs/DAILY_REVIEW_IMPLEMENTATION.md` - Daily Review patterns (NEW!)
...
- [ ] Read relevant implementation guide (e.g., `web-ui/docs/DAILY_REVIEW_IMPLEMENTATION.md`)
...
**What's missing:**
- Add Daily Review section to `web-ui/docs/WEB_UI_GUIDE.md`
- Update `docs/product/DAILY_USAGE_GUIDE.md` with new workflow
