...
- **Final-close boundary**: every `final_close` screener run requires yfinance and Polygon cache files written after the selected session's latest active-market close; explicitly intraday runs do not apply that threshold
