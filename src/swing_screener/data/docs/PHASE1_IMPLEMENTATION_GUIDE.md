...
> **Status: Archived (Phase 1 complete).** Historical snapshot from February 2026; phases 2+ have since completed. Use `/docs/overview/INDEX.md` and `/src/swing_screener/data/docs/BROKER_INTEGRATION.md` for current guidance.  
...
6. **Documentation**: Complete guide in `src/swing_screener/data/docs/BROKER_INTEGRATION.md`
...
See `mcp_server/docs/PHASE2_MCP_COMPLETE.md`, `docs/engineering/ROADMAP.md`, and `mcp_server/docs/MCP_SERVER_COMPLETE.md` for current state.
...
- Create `src/swing_screener/data/docs/BROKER_INTEGRATION.md`
