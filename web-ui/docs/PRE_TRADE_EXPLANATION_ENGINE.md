...
The pipeline is:
```
Strategy Rules → Structured Facts → Explanation Layer → (Optional) LLM Simplifier
```
...
|--------|-------------|-------------|
| **Trend Strength** | ⭐⭐⭐⭐⭐ | Based on distance from SMA200 and trend status |
| **Volatility Control** | ⭐⭐⭐⭐⭐ | Inverse rating: 5 stars = low vol, 1 star = high vol |
| **System Conviction** | ⭐⭐⭐⭐⭐ | Based on confidence score (0-100) |
...
- [OPERATIONAL_GUIDE.md](../../docs/engineering/OPERATIONAL_GUIDE.md) - Daily usage
