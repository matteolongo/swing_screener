...
- **CLI Alternative:** See `docs/engineering/OPERATIONAL_GUIDE.md` for CLI workflows
- **Daily Routine:** See `docs/product/DAILY_USAGE_GUIDE.md` for Barcelona/CET timing
