...
describe('portfolio api', () => {
  it('uses the stateless projection for local metrics without recalculating or saving it', async () => {
    ...
    const summary = { total_positions: 1, total_value: 989.43, total_cost_basis: 899.12, total_pnl: 81.02, total_pnl_percent: 9.01, open_risk: 44.96, open_risk_percent: 0.44, account_size: 10000, available_capital: 9011.12, largest_position_value: 989.43, largest_position_ticker: 'AAPL', best_performer_ticker: 'AAPL', best_performer_pnl_pct: 9.123, worst_performer_ticker: 'AAPL', worst_performer_pnl_pct: 9.123, avg_r_now: 1.8246, positions_profitable: 1, positions_losing: 0, win_rate: 100, concentration: [], realized_pnl: 0.55, effective_account_size: 10000.55,
      analytics: { closed_trade_count: 1, excluded_trade_count: 0, win_count: 1, loss_count: 0, scratch_count: 0, win_rate: 100, win_rate_status: 'positive', average_r: 2, average_max_r: 3, profit_factor: null, profit_factor_status: 'neutral', average_holding_days: 4, max_win_streak: 1, max_loss_streak: 0, equity_curve: [{ position_id: 'POS-1', ticker: 'AAPL', date: '2026-09-09', r: 2, max_r: 3, holding_days: 4, cumulative_r: 2, tags: ['breakout'], entry_price: 100, exit_price: 110, shares: 1, initial_risk: 5, thesis: null, notes: '', lesson: null }], tag_breakdown: [], journal_tag_breakdown: [{ tag: 'breakout', trade_count: 1, win_count: 1, loss_count: 0, scratch_count: 0, average_r: 2, average_max_r: 3 }], insight: { verdict: 'positive', reason: 'positive_edge' } },
      analytics_metadata: { heat_status: 'warning', heat_warning_pct: 4, heat_max_pct: 6, concentration_warning_pct: 60, tag_min_sample_size: 5 } };
    ...
    expect(await fetchPortfolioSummary()).toMatchObject({ totalValue: 989.43, availableCapital: 9011.12, analytics: { winRateStatus: 'positive', profitFactorStatus: 'neutral', averageMaxR: 3, equityCurve: [{ maxR: 3, holdingDays: 4, tags: ['breakout'], entryPrice: 100, exitPrice: 110, shares: 1, initialRisk: 5 }], journalTagBreakdown: [{ averageR: 2, averageMaxR: 3 }], insight: { verdict: 'positive', reason: 'positive_edge' } }, analyticsMetadata: { heatStatus: 'warning' } });
