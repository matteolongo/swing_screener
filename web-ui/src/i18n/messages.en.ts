export const messagesEn = {
  ...
  backtest: {
    title: 'Backtest',
    subtitle: 'Replay the live signal, stop and exit rules over history. Results are in R-multiples.',
    scopeNote:
    ...
    form: {
      ...
      tickersHint: 'Comma or space separated.',
      start: 'Start',
      end: 'End',
      dateHint: 'Optional. Defaults to 2022 through today.',
  ...
  workspacePage: {
    ...
    intelligence: {
      inputs: {
        title: 'Analysis inputs and sources',
        description: 'Review the evidence snapshot before explicitly generating an advisory analysis.',
        source: 'Source',
        provider: 'Provider',
        asOf: 'As of',
        cache: 'Cache state',
      ...
      sources: {
        screener: 'Screener setup',
        prices: 'Daily prices',
        fundamentals: 'Fundamentals',
        evidence: 'News and evidence',
        positionOrders: 'Position and orders',
        earnings: 'Earnings',
        dividend: 'Dividend',
        technicals: 'Technical indicators',
        polygon_prices: 'Polygon prices',
      },
      ...
      failed: 'The analysis pipeline failed.',
      loadingCached: 'Loading the latest saved analysis…',
      outdated: 'Analysis is outdated because a dependency is newer.',
      empty: 'No analysis has been generated. Review the inputs, then generate when ready.',
      followUps: 'Optional follow-ups',
      historyAndTrace: 'History and technical trace',
      status: {
      ...
      steps: {
        enriching: 'Enriching inputs',
        prompting: 'Preparing context',
        generating: 'Generating analysis',
    ...
    emptyDescription: 'Run the screener and select a symbol to see its analysis, trade plan, and intelligence.',
    data: {
      ...
      activityFailed: 'Data request failed',
      activitySelectionChanged: 'Workspace selection changed before completion.',
      activityRefreshFailed: 'Workspace refresh failed.',
      activityPhases: {
        active: 'Active',
        completed: 'Completed',
        partial: 'Partial',
      ...
      retry: 'Retry',
      retryActivity: 'Retry {{source}} for {{ticker}}',
      ...
      details: {
        ...
        inputs: {
          ...
          screenerRunMetadata: 'Screener run metadata',
          screenerProvider: 'Screener provider',
    ...
    fundamentals: {
      ...
      card: {
        ...
        contextUnavailable: 'Snapshot context unavailable',
        qualityBadge: 'quality {{status}}',
        dataQuality: 'Data quality',
        overallRead: 'Overall read',
        readPositive: 'Positive',
        readWeak: 'Weak',
        readMixed: 'Mixed',
        overallHint: 'Use the pillar scores and trust notes below to confirm the quality of the setup.',
        keySupports: 'Key supports',
        noSupports: 'No strong support stands out yet.',
        mainConcerns: 'Main concerns',
        noConcerns: 'No major fundamental red flag is currently visible.',
        trustHigh: 'Coverage looks stable enough for directional use.',
        trustCaution: 'Use extra care when relying on the current fundamentals snapshot.',
        qualityStatus: 'Quality status: {{status}}',
        ...
        metrics: {
          revenueGrowthYoy: 'Revenue YoY',
          earningsGrowthYoy: 'Earnings YoY',
          operatingMargin: 'Operating margin',
          freeCashFlowMargin: 'FCF margin',
    ...
    overview: {
      ...
      opposition: 'Opposing evidence',
      supportingSignal: 'Supporting signal',
      opposingSignal: 'Opposing signal',
      noSignals: 'No signals available.',
      fundamentals: 'Fundamentals',
      catalysts: 'Catalysts',
      openFundamentals: 'Open Fundamentals',
      openIntelligence: 'Open Intelligence',
      fundamentalsSummary: 'P/E {{pe}} · Revenue growth {{growth}} · Gross margin {{margin}}',
      loading: 'Loading…',
      notAvailable: 'Not available',
      partialDependencies: 'Available content is shown. Unavailable: {{dependencies}}.',
      intelligenceOutdated: 'Intelligence is older than the latest workspace inputs.',
      reviewFallback: 'Review the current setup, risk, and execution plan before acting.',
      nextStep: 'Next step',
      watch: 'Watch',
      unwatch: 'Unwatch',
    ...
    panels: {
      ...
      analysis: {
        ...
        volumeZones: {
          ...
          loading: 'Analyzing volume zones...',
          loadError: 'Failed to load volume-zone analysis',
          candlesLoading: 'Loading price candles…',
          candlesFailed: 'Price candles are unavailable. The analysis summary remains available.',
          sources: 'Data and parameters',
          candleProvider: 'Candle provider',
          candleInterval: 'Candle interval',
          latestCandleDate: 'Latest candle date',
          fetchedAt: 'API fetched at',
          ...
          zoneRole: 'Role',
          zonePrice: 'Center',
          zoneShare: 'Volume share',
          approximateLimitation:
            'Approximate only: this bar-based profile uses daily OHLCV, not tick-level traded volume, and must not be treated as exact execution liquidity.',
          action: 'Action',
          bias: 'Bias',
          setup: 'Setup',
          ...
          rr: 'R:R',
          rationale: 'Why',
          noSetup: 'No actionable volume-zone setup right now.',
          poc: 'POC',
          hvn: 'HVN',
          lvn: 'LVN',
        },
        intelligence: {
          ...
          chat: {
            ...
            empty: 'Ask a question about this analysis or request a source refresh.',
          ...
          strategic: {
            title: 'Strategic overlay',
            description: 'Manual macro/news context layer for when technical follow-through may need extra caution.',
            ...
            refreshSources: 'Refresh app sources first',
            runError: 'Failed to run strategic overlay',
            idle: 'Run this manually when a position moves hard, a macro/geopolitical event appears relevant, or you want to reinterpret the current analysis without creating a trade action.',
            appContextOnly: 'App-context only · refreshed sources: {{count}}',
            whyNow: 'Why now',
          ...
          agentTrace: {
            ...
            onlyTiming: 'This step recorded only timing (no captured detail).',
            steps: 'Steps',
            duration: '{{ms}} ms',
            subMs: '<1 ms',
            seconds: '{{s}} s',
            ...
            stepLabels: {
              ...
              enrich_technicals: 'Enrich technicals',
              enrich_polygon: 'Enrich prices (Polygon)',
              resolve_context: 'Resolve context',
              assemble_inputs: 'Assemble inputs',
              build_prompt: 'Build prompt',
              search: 'Web search + narrative',
              format: 'Format to schema',
              postprocess: 'Post-process',
              weigh_evidence: 'Weigh evidence',
              assemble_result: 'Assemble result',
              persist: 'Persist',
            },
            tabs: {
              data: 'Data',
  ...
  screener: {
    ...
    controls: {
      ...
      useForToday: "Use this run for Today's review",
      useForTodayShort: "Today's source",
      members: 'members',
    ...
    summary: {
      ...
      notTodaySource: "This is an exploration run. Today's review still uses its pinned source.",
      useForToday: 'Use this run for Today',
    },
    glossary: {
  ...
  universesPage: {
    ...
    subtitle: 'Review source coverage, freshness, validation, and refresh official universes without editing snapshots by hand.',
    config: {
      noSelection: 'Select a universe to inspect it.',
      loading: 'Loading universe detail…',
      error: 'Failed to load universe detail.',
      ...
      configuredBenchmark: 'Configured benchmark {{benchmark}}',
      rules: 'Rules',
      noCurrencyRule: 'No currency rule',
      anyExchange: 'Any exchange',
      benchmark: 'Benchmark',
      benchmarkDescription: 'Select the index or ETF used for performance comparison in the screener and chart overlay.',
      benchmarkSymbol: 'Benchmark symbol',
      saving: 'Saving…',
      saveBenchmark: 'Save benchmark',
      updateBenchmarkError: 'Failed to update benchmark.',
      benchmarkUpdated: 'Benchmark updated to {{benchmark}}. The catalog and screener will pick it up after refresh.',
      refreshing: 'Refreshing…',
      previewRefresh: 'Preview Refresh',
      applyRefresh: 'Apply Refresh',
      manualOnly: 'This universe is manual-only for now.',
      refreshFailed: 'Refresh failed.',
      refreshPreview: 'Refresh Preview',
      currentMembers: '{{count}} current',
      proposedMembers: '{{count}} proposed',
      appliedLocally: 'Applied locally',
    ...
    discovery: {
      ...
      description: 'Pull fresh candidate symbols from free sources, then review their market, currency, and exchange taxonomy before screening.',
      discovering: 'Discovering…',
      discoverSymbols: 'Discover Symbols',
      ...
      top: 'Top {{count}}',
      yahooStatusScreens: 'Yahoo status screens',
      yahooCustomScreener: 'Yahoo will use its custom screener endpoint for this market because predefined screeners are mostly US-centric.',
      eodhdNeedsKey: 'EODHD exchange discovery needs `EODHD_API_KEY` configured in the backend environment. Without it, the request will return a setup error instead of live EUR symbols.',
      error: 'Symbol discovery failed.',
      candidates: '{{count}} candidates',
      asOf: 'as of {{date}}',
      screening: 'Screening…',
      runScreener: 'Run Screener on These Symbols',
      noMatches: 'No symbols matched this discovery source and filter set. Try a broader market, lower liquidity filters, or screen one of the configured universes below.',
      taxonomy: {
        currency: 'Currency',
  ...
  strategyCapitalRisk: {
    ...
    risk: 'Risk',
    account: 'Account',
    riskPerTrade: 'Risk / trade {{amount}} ({{pct}})',
    maxPosition: 'Max position {{amount}}',
    title: 'Capital Risk at a Glance',
    description: 'This strategy sizes positions from the active risk settings below. The education sections underneath still explain why each parameter matters.',
    accountSize: 'Account Size',
    capitalAtRisk: 'Capital at Risk / Trade',
    accountPct: '{{pct}} of the account',
  ...
  todayPage: {
    ...
    actionList: {
      ...
      loadingPinnedCandidates: "Loading today's pinned candidates...",
      loadingReview: 'Loading portfolio review...',
      loadingPositions: 'Loading positions...',
      loadingWatchlist: 'Loading watchlist...',
      retryReview: 'Retry review',
      retryPositions: 'Retry positions',
      retryWatchlist: 'Retry watchlist',
      closeAction: 'Close →',
      updateAction: 'Update →',
      timeStopBadge: '{{days}}d / {{r}}R',
      timeStopWarning: 'Stale trade: consider closing or documenting a reason to hold.',
      ...
      earningsTitle: 'Earnings in {{days}} day(s)',
      exhaustionTitle: 'Exhaustion: {{score}}/10',
      volumeStrongTitle: 'Volume {{ratio}}× average (strong)',
      volumeWeakTitle: 'Volume {{ratio}}× average (weak)',
      riskReward: 'R/R: {{value}}R',
      aiSignal: {
        HOLD: 'Hold',
        TRIM: 'Trim',
        EXIT: 'Exit',
