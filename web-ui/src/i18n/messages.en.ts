export const messagesEn = {
  ...
  workspacePage: {
    ...
    panels: {
      ...
      analysis: {
        ...
        fundamentalsLoading: 'Loading fundamentals...',
        fundamentalsError: 'Failed to load fundamentals',
        fundamentalsEmpty: 'No fundamentals snapshot available.',
      },
      chat: {
  ...
  screener: {
    ...
    identity: {
      ...
      fundamentalsLabel: 'Fundamentals {{coverage}}',
      fundamentalsLabelWithFreshness: 'Fundamentals {{coverage}} · {{freshness}}',
    },
    setup: {
      entry: 'Entry',
      stop: 'Stop',
  ...
  fundamentalsPage: {
    title: 'Fundamentals',
    subtitle: 'Compare company-quality snapshots without changing the screener ranking.',
    symbolsLabel: 'Symbols',
    symbolsPlaceholder: 'AAPL, MSFT, NVDA',
    compareButton: 'Compare fundamentals',
    comparingButton: 'Comparing...',
    symbolsHint: 'Enter at least two single-stock tickers.',
  },
  workspaceFundamentals: {
    loading: 'Loading fundamentals...',
    error: 'Failed to load fundamentals',
    empty: 'No fundamentals snapshot available.',
