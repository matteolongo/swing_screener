export const messagesEn = {
  ...
  order: {
    ...
    candidateModal: {
      ...
      degiroConfigTitle: 'DeGiro setup guide',
      degiroConfigEntryStep: 'Step 1: Entry order',
      degiroConfigEntryType: 'Order type: {{entryType}}',
      degiroConfigEntryPriceLabel: '{{label}}: {{price}}',
      degiroConfigEntryQuantity: 'Quantity: {{quantity}}',
      degiroConfigProtectionStep: 'Step 2: Stop-loss protection',
      degiroConfigProtectionType: 'Order type: Sell Stop Loss',
      degiroConfigProtectionPrice: 'Stop price: {{price}}',
      degiroConfigProtectionQuantity: 'Quantity: {{quantity}}',
      degiroConfigTerminology: 'In DeGiro, a Buy Stop entry appears under "Acquisto" as "Stop Loss" on the buy side.',
      degiroEntryTypeStop: 'Buy Stop',
      degiroEntryTypeLimit: 'Buy Limit',
      degiroEntryTypeMarket: 'Buy Market',
      degiroEntryPriceStopLabel: 'Trigger price',
      degiroEntryPriceLimitLabel: 'Limit price',
      degiroEntryPriceMarketLabel: 'Price',
      degiroEntryPriceMarketValue: 'Market (best available)',
      labels: {
        score: 'Score',
        rank: 'Rank',
        sector: 'Sector',
  ...
  pendingOrdersTab: {
    ...
    degiroNotConnected: 'DeGiro is not connected',
  },
  fillViaDegiroModal: {
